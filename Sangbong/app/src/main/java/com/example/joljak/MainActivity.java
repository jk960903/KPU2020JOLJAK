...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    // URL 설정.
    static String url = "http://192.168.62.47/PHP_connection.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        str1 = sf.getString("ID", "");
        ID.setText(str1);
        String str = sf.getString("USERADDRESS", "");
    ...
    public class BluetoothThread implements Runnable {
        ...
        public void HeartSend(String message) {
            ...
            HeartRequest heartRequest = new HeartRequest(str1,message, responseListener);//heratrate 들어가야함
    ...
    private class getDrug extends AsyncTask<String,Void,String> {
        String serverURL = "http://192.168.62.120/medicine_query1.php";
        @Override
