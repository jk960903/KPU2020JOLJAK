...
public class GPSActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    @Override
    public void onLocationChanged(Location location){//카메라 위치가 변경되었을때 오버라이딩
    ...
    private String getCurrentAddress(LatLng latlng){//현재 주소 반환
        ...
        try{
            ...
            Toast.makeText(this,"GPS 좌표 오류",Toast.LENGTH_LONG).show();
            return "잘못된 GPS 좌표";
        }
    ...
    public void setDefaultLocation(){
        ...
        LatLng DEFAULT_LOCATION=new LatLng(37.56,126.97);//위치 서울로 설정(블루투스 연결이 안되었거나 인터넷 연결이 안되 구글 api를 가져올수 없음)
    ...
    private void checkPermission(){
        ...
        if(hasFineLocationPermission==PackageManager.PERMISSION_DENIED&&fineLocationRationale)
            ...
            showDilogForPermissionSettings("위치 정보 승인 거부");
...
@TargetApi(Build.VERSION_CODES.M)
    ...
    private void showDilogForPermissionSettings(String msg){
        AlertDialog.Builder builder=new AlertDialog.Builder(GPSActivity.this);
        builder.setTitle("알림");
        builder.setMessage(msg);
