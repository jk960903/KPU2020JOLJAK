...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FindAcount=(Button)findViewById(R.id.findAccount);
        GetAccount=(Button)findViewById(R.id.getAccount);

        GetAccount.setOnClickListener(new Button.OnClickListener(){
            @Override
            public void onClick(View v){
                //회원가입 링크로 이동
                Intent intent=new Intent(LoginActivity.this,GetAccount.class);
                startActivityForResult(intent,GETACCOUNT_OK);
